...
class male_data extends StatefulWidget {

  @override
  State<male_data> createState() => _male_dataState();

}

class _male_dataState extends State<male_data> {
  ...
  get() async {
    ...
    studentData = await maleStudentData();
    setState(() {
      isFetching = false;
      Loading = true;
    });
  ...
  Widget build(BuildContext context) {
    return isFetching ? const Center(child: CircularProgressIndicator(),):studentData!.isNotEmpty?
    Padding(
